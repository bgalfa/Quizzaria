...
Contains simple UI where user can select the category of quiz that user wishes to take, each field contains 50 questions in the data base out of 15 are chosen at random.
